###############################################
###### Introduction to R - Bootcamp 2024 ######
###############################################
# by Kevin Kane, PhD
...
colnames(d)[4] = "totpop"
varlist = c('B19001_001', 'B01002_001', 'B03002_001', 'B03002_003', 'B03002_004', 'B03002_005', 'B03002_006', 'B03002_007', 
            'B03002_008', 'B03002_009', 'B03002_012', 'B05001_001', 'B05001_006', 'B07001_001', 'B07001_017', 'B07001_033', 
            'B07001_049', 'B07001_065', 'B08014_001', 'B08014_002', 'B08014_003', 'B08014_004', 'B08014_005', 'B08014_006', 
            'B08014_007', 'B08101_001', 'B08101_009', 'B08101_033', 'B08101_017', 'B08101_025', 'B08101_041', 'B08101_049', 
            'B15003_001', 'B15003_002', 'B15003_003', 'B15003_004', 'B15003_005', 'B15003_006', 'B15003_007', 'B15003_008', 
            'B15003_009', 'B15003_010', 'B15003_011', 'B15003_012', 'B15003_013', 'B15003_014', 'B15003_015', 'B15003_016',
            'B15003_017', 'B15003_018', 'B15003_019', 'B15003_020', 'B15003_021', 'B15003_022', 'B15003_023', 'B15003_024', 
            ...
            'B19001_017', 'B19013_001', 'B23025_001', 'B23025_002', 'B25031_001', 'B25077_001', 'B25034_001', 'B25034_002',
            'B25034_003', 'B25034_004', 'B25034_005', 'B25034_006', 'B25034_007', 'B25034_008', 'B25034_009', 'B25034_010',
            'B25034_011', 'B25035_001', 'B25024_002', 'B25024_003', 'B25024_004', 'B25024_005', 'B25024_006', 'B25024_007',
            'B25024_008', 'B25024_009', 'B25024_010', 'B25024_011', 'B25003_001', 'B25003_002', 'B25003_003', 'B01001_003', 
...
for(i in 1:length(unique(unlist(d2$variable)))){
  join = subset(d2, variable==varlist[i])
  d[,ncol(d)+1] = join$estimate[match(d$GEOID, join$GEOID)]
  colnames(d)[ncol(d)] = varnames[i]  
}

# Prep some useful summary variables
d$hhinc_sub20 = d$hincund10 + d$hinc1014 + d$hinc1519
d$hhinc_over100 = d$hinc100124 + d$hinc125149 + d$hinc150199 + d$hinc200pl
d$BAplus = d$educ_doct + d$educ_prof + d$educ_mast + d$educ_bach
d$noHS = d$tot4_educ - d$BAplus - d$educ_asso - d$educ_some - d$educ_cnud1 - d$educ_ged - d$educ_hs
d$age0017 = d$male0005 + d$male0509 + d$male1014 + d$male1517 + d$female0005 + d$female0509 + d$female1014 + d$female1517
d$age65plus = d$male6566 + d$male6769 + d$male7074 + d$male7579 + d$male8084 + d$male8500 + d$female6566 + d$female6769 + d$female7074 + d$female7579 + d$female8084 + d$female8500

# Carefully write to a .csv
write.csv(d, "C:/Users/kane/Dropbox/usc_emup/R_bootcamp/Cook_tracts_ACS22.csv")

# Carefully write to a .shp
st_write(d, "C:/Users/kane/Dropbox/usc_emup/R_bootcamp/Cook_tracts_ACS22.shp")
